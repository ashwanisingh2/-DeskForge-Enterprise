export const permissions={
 ADMIN:['*'],
 AGENT:['ticket:create','ticket:read:any','ticket:update','comment:create','asset:read','kb:write','report:view'],
...
export type Permission='ticket:create'|'ticket:read:any'|'ticket:read:own'|'ticket:update'|'ticket:delete'|'comment:create'|'user:manage'|'settings:admin'|'report:view'|'asset:read'|'asset:admin'|'kb:read'|'kb:write';
